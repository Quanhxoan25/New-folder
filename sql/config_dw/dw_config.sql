...
CREATE TABLE IF NOT EXISTS fact_player_statistics (
    game_id INTEGER,
    date_id INTEGER,
    person_id INTEGER,
    ...
    PRIMARY KEY (game_id, date_id, person_id),
    FOREIGN KEY (game_id) REFERENCES dim_game(game_id),
    FOREIGN KEY (date_id) REFERENCES dim_date(date_id),
    FOREIGN KEY (person_id) REFERENCES dim_players(person_id),
    FOREIGN KEY (player_team_id) REFERENCES dim_team(team_id),
